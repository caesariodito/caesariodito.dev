  ...
  const journalEntries = [
    {
      ...
      excerpt:
        "Spent 3 hours tracking down a race condition today. Initially frustrated, then realized this is exactly where growth happens...",
      mood: "🧘",
      growth:
        "Practiced mindful debugging—each console.log was an investigation, not a complaint.",
      version: "v1.2.3",
    },
    {
      date: "2024-03-12",
      ...
      excerpt:
        "Gave feedback on a PR today and realized how my tone in comments affects team culture...",
      mood: "🤝",
      growth:
        "Experimented with 'appreciation + question + suggestion' format for reviews.",
      version: "v1.2.2",
    },
    {
      date: "2024-03-10",
      ...
      category: "Boundaries",
      excerpt:
        "Declined a freelance project that would have paid well but conflicted with my values around work-life balance...",
      mood: "💚",
      growth:
        "Practiced values-based decision making over financial optimization.",
      version: "v1.2.1",
    },
    {
      date: "2024-03-08",
      ...
      excerpt:
        "Cleaned up a legacy component today. Each function extraction felt like a breath of fresh air...",
      mood: "✨",
      growth:
        "Found flow state in systematic improvement—small changes, big impact.",
      version: "v1.2.0",
    },
    {
      date: "2024-03-05",
      ...
      excerpt:
        "Mentored a junior developer on React hooks. Explaining concepts clarified my own understanding...",
      mood: "🌱",
