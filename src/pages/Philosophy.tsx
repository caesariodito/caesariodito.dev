  ...
  const principles = [
    {
      ...
      details: "The industry often glorifies the 'grind,' but I've learned that sustainable progress comes from working in harmony with your natural rhythms. I prioritize deep work sessions followed by restorative breaks, meaningful weekends, and saying no to opportunities that don't align with my values."
    },
    {
      title: "Reflection over Reactivity",
      icon: "🪞",
      description: "Pause, process, then proceed with purpose.",
      details: "In both code and life, my first instinct isn't always my best response. Daily journaling helps me process challenges, celebrate wins, and approach problems with curiosity rather than frustration. This practice has made me a better debugger and a more thoughtful team member."
    },
    {
      title: "Progress over Perfection",
      icon: "🌱",
      description: "1% better daily compounds into extraordinary growth.",
      details: "Perfect code doesn't exist, but better code does. I focus on atomic improvements—cleaner functions, better naming, more thoughtful architecture. Small, consistent improvements in both my technical skills and personal habits create lasting transformation."
    },
    {
      title: "Connection over Competition",
      icon: "🤝",
      description: "We rise by lifting others in our community.",
      details: "The tech industry can feel competitive, but I've found more fulfillment in collaboration. Mentoring junior developers, contributing to open source, and sharing knowledge openly has enriched my own learning journey while building meaningful professional relationships."
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <section className="py-16 text-center">
          ...
          <p className="text-xl text-stone-600 dark:text-stone-300 leading-relaxed max-w-3xl mx-auto">
            The principles that guide my approach to code, career, and continuous growth.
          </p>
        </section>
        ...
        <section className="py-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {codeQuotes.map((item, index) => (
              <Card key={index} className="p-6 bg-gradient-to-br from-amber-50 to-stone-50 dark:from-amber-900/10 dark:to-stone-800 border-amber-200 dark:border-stone-700">
        ...
        <section className="py-16 text-center">
          <Card className="p-8 bg-gradient-to-br from-amber-50 to-stone-50 dark:from-amber-900/10 dark:to-stone-800 border-amber-200 dark:border-stone-700">
            <blockquote className="text-2xl font-light text-stone-800 dark:text-stone-200 leading-relaxed mb-4">
              "The code we write is a reflection of who we are. 
              The person we become is shaped by how we write code."
            </blockquote>
            <p className="text-stone-600 dark:text-stone-400">
              — Personal reflection on the symbiotic relationship between craft and character
            </p>
          </Card>
        </section>
      </div>
